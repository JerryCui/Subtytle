...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig localSubtitleDaoConfig;
    private final DaoConfig movieSearchResultDaoConfig;

    private final MovieDao movieDao;
    private final SubtitleDao subtitleDao;
    private final LocalSubtitleDao localSubtitleDao;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        localSubtitleDaoConfig = daoConfigMap.get(LocalSubtitleDao.class).clone();
        localSubtitleDaoConfig.initIdentityScope(type);
        ...
        localSubtitleDao = new LocalSubtitleDao(localSubtitleDaoConfig, this);
        ...
        registerDao(LocalSubtitle.class, localSubtitleDao);
    ...
    public void clear() {
        ...
        localSubtitleDaoConfig.getIdentityScope().clear();
