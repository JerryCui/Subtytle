...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        LocalSubtitleDao.createTable(db, ifNotExists);
        MovieSearchResultDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        LocalSubtitleDao.dropTable(db, ifExists);
        MovieSearchResultDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(LocalSubtitleDao.class);
        registerDaoClass(MovieSearchResultDao.class);
    }
