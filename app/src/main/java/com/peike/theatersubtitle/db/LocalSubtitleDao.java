...
/** 
 * DAO for table "LOCAL_SUBTITLE".
*/
public class LocalSubtitleDao extends AbstractDao<LocalSubtitle, Long> {

    public static final String TABLENAME = "LOCAL_SUBTITLE";

    /**
     * Properties of entity LocalSubtitle.<br/>
    ...
    */
    ...
    public LocalSubtitleDao(DaoConfig config) {
        super(config);
    }
    
    public LocalSubtitleDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LOCAL_SUBTITLE\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LOCAL_SUBTITLE\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, LocalSubtitle entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public LocalSubtitle readEntity(Cursor cursor, int offset) {
        LocalSubtitle entity = new LocalSubtitle( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, LocalSubtitle entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(LocalSubtitle entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(LocalSubtitle entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
